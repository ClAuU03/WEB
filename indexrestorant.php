           ...
           <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            { while($row= mysqli_fetch_array ($kategori))
              {   ?>
                ...
                href="index.php"><?php echo $row["kategoriNAMA"]?></a></li>
           <?php  }
            }?> 
...
<div class="col-sm-8"  style="background: #2f3640" >         <!-- sm untuk kalo dibuka di hape , untuk menyesuaikan ukuran kolom di hape -->
    <?php 
      if (mysqli_num_rows($restorantinfo)>0)
      {
         while ($row=mysqli_fetch_array($restorantinfo))
         {   ?>
    <div class="d-flex">
    ...
    <img style="width: 200px; height: 100%;"src="admin/images/<?php echo $row["restorantFOTO"]?>" alt="No Image">
        ...
        <div class="flex-grow-1" style="margin-left: 20px; color: white;">
            ...
            <p><?php echo substr($row ["restorantKET"],0,150)?> ...</p>
            <a href="readmoreresto.php?detail=<?php echo urlencode($row["restorantKODE"])?>" class="btn btn-warning btn-outline-light">Read More </a>
...
<h1 class="card-title" style="margin-bottom: 40px;">Aneka Oleh-Oleh</h1>
  <?php 
  ...
  ?>
                ...
                <div class="col-lg-4">
                  <div class="card" style="background:#f5f6fa;">
                    <img
                      src="admin/images/<?php echo $row["olehFOTO"]?>"
                      class="card-img-top"
                      alt="Waterfall"
                      style="height:100%;"
                    />
                    <div class="card-body">
                      ...
                      <p class="card-text"><?php echo $row ["provinsiNAMA"] ?><span>,</span> <?php echo $row ["provinsiIBUKOTA"]?>
                      </p>
                      <a href="detailsoleh.php?detail=<?php echo urlencode($row["olehKODE"])?>" class="btn btn-warning btn-outline-light">Details</a>
                    </div>
                  </div>
                </div>
  <?php
