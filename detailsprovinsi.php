...
if (isset($_GET['detail'])) {
  ...
  $query = "SELECT * FROM provinsi WHERE provinsiKODE = '$detail'";
  $result = mysqli_query($connection, $query); }
      ...
      <img style="width: 200px; height: 100%;"src="admin/images/<?php echo $row["provinsiFOTO"]?>" alt="No Image">
          <div class="flex-shrink-0">
          <!-- height: 100% ngikutin widthnya -->
          </div> <!--penutup flexshrink -->
          <div class="flex-grow-1" style="margin-left: 20px; color: white;">
              <h2><?php echo $row["provinsiNAMA"]?> <small class="text-muted" style="font-size: 15px;">
                <i style="color: #f9ca24"><?php echo $row ["provinsiIBUKOTA"]?></i></small></h2>
              <p><?php echo $row ["provinsiKET"]?></p>
