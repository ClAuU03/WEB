...
<div class="row">
<div class="col-sm-11"  style="background: #2f3640" >         <!-- sm untuk kalo dibuka di hape , untuk menyesuaikan ukuran kolom di hape -->
<?php
if (isset($_GET['detail'])) {
  $detail = urlencode($_GET['detail']);
  $query = "SELECT * FROM travel, claudya WHERE travel.travelKODE = '$detail' AND travel.berita0049 = claudya.berita0049";
  $result = mysqli_query($connection, $query); }
      ...
      <img style="width: 200px; height: 100%;"src="admin/images/<?php echo $row["travelFOTO"]?>" alt="No Image">
          <div class="flex-shrink-0">
          <!-- height: 100% ngikutin widthnya -->
          </div> <!--penutup flexshrink -->
          <div class="flex-grow-1" style="margin-left: 20px; color: white;">
              <h2><?php echo $row["travelKENDARAAN"]?> <small class="text-muted" style="font-size: 15px;">
                <i style="color: #f9ca24"><?php echo $row ["kategoriberita0049"]?></i></small></h2>
              <p><?php echo $row ["event0049"]?></p>
