...
if (isset($_GET['detail'])) {
  ...
  $query = "SELECT * FROM destinasi, kategoriwisata WHERE destinasi.destinasiKODE = '$detail' AND destinasi.kategoriKODE = kategoriwisata.kategoriKODE";
