...
<?php 
	...
	if(isset($_POST['edit']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
		{
            ...
            mysqli_query($connection, "UPDATE provinsi SET provinsiNAMA ='$namaprovinsi', provinsiIBUKOTA= '$ibukotaprovinsi' 
            , provinsiKET='$ketprovinsi', provinsiFOTO = '$namafile'
...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="kodeprovinsi" name="inputkode" 
                placeholder="Kode provinsi" maxlength="4" value="<?php echo $rowedit ["provinsiKODE"];?>" readonly> 
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="namaprovinsi" name="inputnama" 
                placeholder="Nama Provinsi" value="<?php echo $rowedit ["provinsiNAMA"];?>"> 
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
            <input type="text" class="form-control" id="ibukotaprovinsi" name="inputibukota" 
            placeholder="Ibukota Provinsi" value="<?php echo $rowedit ["provinsiIBUKOTA"];?>"> 
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
            <input type="text" class="form-control" id="ketprovinsi" name="inputket" 
			placeholder="Keterangan Provinsi" value="<?php echo $rowedit ["provinsiKET"];?>">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input type="file" id="file" name="file" value="<?php echo $rowedit ["provinsiFOTO"];?>"> >
