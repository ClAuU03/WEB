...
<?php 
    ...
    session_start();             //session dipake buat ngatur contohnya gabisa lgsg akses dashboard admin tpi harus melewati form login dulu
    //session_start  untuk mengaktifkan sesinya

    //jadi bikin juga di form tujuan untuk sblm masuk harus pindah ke loginnya


    if (isset($_POST["submitlogin"]))       //file yang di entry diterima di "submitlogin" 
    {
        ...
        if (mysqli_num_rows($sql_login)>0)      //dicek apakah $sql login ada isi, kalau ada isi kn lebih dari 0
        {
