...
<form method= "POST">       <!--boleh post,get,request-->
  ...
  <div class="form-group row mb-3 row">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="inputkode" name="inputkode" placeholder="Kode Khas">
    </div>
  </div>
  ...
  <div class="form-group row mb-3 row">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="inputdaerah" name="inputdaerah" placeholder="Nama Daerah">
    </div>
  </div>
  ...
  <div class="form-group row mb-3 row">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="inputket" name="inputket" placeholder="Keterangan Khas">
    </div>
  </div>
...
<div class="jumbotron">
        <h2 class="display-5">Hasil entri data Masakan Khas Daerah</h2> 
</div>
...
if (isset($_POST["kirim"])) 
{
  ...
  $query =mysqli_query ($connection, "select khas. * from khas
        where khasDAERAH like '%".$search."%'limit $mulaitampilan, $jumlahtampilan");
        // --------------------- PAGING -- MEMBUAT GANTI HALAMAN ---------------- 
