...
<?php
    ...
    if(isset ($_POST['edit']))
    {
        ...
        mysqli_query ($connection, "UPDATE claudya set berita0049 = '$berita0049',
        beritaclau = '$beritaclau', kategoriberita0049 = '$kategoriberita0049' 
        , event0049 = '$event0049'
        where berita0049 ='$berita0049' ");   //kalau untuk dlm query tanda petik hrs 1 aja
        header("location: claudya0049.php");
    }
    $kodeberita = $_GET['ubah'];  //'ubah'nya harus sama yg di file mahasiswa.php
    $editberita = mysqli_query ($connection, "select * from claudya
              where berita0049 = '$kodeberita'"); 
              $rowedit = mysqli_fetch_array ($editberita);
              /*nnti data yang di ambil akan dicek apakah sama dengan kode berita yang di table, klo iya maka 
              diambil di $rowedit */
...
<div class="col-sm-10">
    ...
    <div class="col-sm-10">
      ...
      value="<?php echo $rowedit ["berita0049"];?>" readonly>       <!-- name: variabel yang akan disimpan kedalam table -->
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      ...
      value="<?php echo $rowedit ["beritaclau"];?>"> 
           <!-- name: variabel yang akan disimpan kedalam table -->
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" name="kategoriberitaKODE" id="kategoriberitaKODE"
    value="<?php echo $rowedit ["kategoriberita0049"];?>"> 
          <!-- name: variabel yang akan disimpan kedalam table -->
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    value="<?php echo $rowedit ["event0049"];?>">         <!-- name: variabel yang akan disimpan kedalam table -->
    </div>
  </div>
