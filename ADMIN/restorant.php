...
<?php 
	...
	if(isset($_POST['Simpan']))
	{
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
		{
            ...
            '$alamatrestorant','$khaskode','$ketrestorant','$namafile')");
...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="koderestorant" name="inputkode" placeholder="Kode Restorant" maxlength="4">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input type="text" class="form-control" id="namarestorant" name="inputnama" placeholder="Nama Restorant">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
            <input type="text" class="form-control" id="alamatrestorant" name="inputalamat" placeholder="Alamat Restorant">
			</div>
		</div>
    ...
    <div class="col-sm-9">
    <select class="form-control" id="kodekhas" name="inputkhas">
  ...
  <div class="form-group row">
			<label for="ketrestorant" class="col-sm-3 col-form-label">Keterangan Restorant</label>
			<div class="col-sm-9">
            <input type="text" class="form-control" id="ketrestorant" name="inputket" placeholder="Keterangan Restorant">
			</div>
		</div>
			...
			if (isset($_POST["kirim"])) 
{
  ...
  $query =mysqli_query ($connection, "select restorant. * from restorant
        where restorantNAMA like '%".$search."%'limit $mulaitampilan, $jumlahtampilan");
// --------------------- PAGING -- MEMBUAT GANTI HALAMAN ---------------- 
//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	
}
else {
  $query =mysqli_query ($connection, "select restorant. * from restorant limit $mulaitampilan, $jumlahtampilan");
//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	
